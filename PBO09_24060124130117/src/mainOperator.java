...
public class mainOperator {
    public static void main(String[] args){
        ...
        Anabul kucing = new Kucing("Kitty", "Kitty", 4.5);
        Anabul Anjing = new Anjing("Doggy", "Doggy");
        ...
        Kucing kucing1 = new Kucing("Garfield", "Garfield", 3.5);
        System.out.println("Bobot kucing 1 adalah " + kucing1.getBobot() + " kg");
        Kucing kucing2 = new Kucing("Tom", "Tom", 1.5);
